...
// Embedded-host bridge (Wireup page 04 and friends): inert unless this
// window is actually inside an iframe. Must init before render so a fast
// parent never posts into the void.
initEmbedBridge();
